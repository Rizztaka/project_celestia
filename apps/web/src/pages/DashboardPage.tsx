  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-zinc-300">
      ...
      <main className="animate-fade-in relative z-10 mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="border-accent-500/30 bg-accent-500/10 relative mb-8 overflow-hidden rounded-2xl border p-1">
          <div className="from-accent-500/20 absolute inset-0 bg-gradient-to-r to-indigo-500/20 blur-xl"></div>
          <div className="bg-celestia-900/80 relative flex items-center justify-between rounded-xl px-6 py-4 backdrop-blur-md">
            <div className="flex items-center gap-4">
              <div className="bg-accent-500/20 text-accent-400 flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
              ...
              <div>
                ...
                <p className="text-accent-200 text-xs">
                  Project Celestia is fully online and ready for deployment.
                </p>
              </div>
            </div>
        ...
        <header className="relative mb-8">
          ...
          <p className="text-muted-foreground text-lg">
            Select a game domain to enter your personalized command center.
          </p>
        </header>
        ...
        <section className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <Link
            to="/roster"
            className="glass-panel group relative block cursor-pointer overflow-hidden border-blue-500/30 p-8 transition-all duration-500 hover:-translate-y-1 hover:border-blue-400 hover:shadow-[0_0_40px_-10px_rgba(59,130,246,0.3)]"
          >
            ...
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-blue-500/20 blur-3xl transition-all duration-700 group-hover:bg-blue-400/30" />

            <div className="relative z-10 flex h-full flex-col">
              <div className="mb-4 flex items-center gap-3">
                <div className="rounded-lg bg-blue-500/20 p-2 text-blue-400 transition-all group-hover:scale-110 group-hover:bg-blue-500/30">
              ...
              <p className="flex-grow text-blue-100/70">
                Manage your Teyvat journey. Optimize your roster, analyze pull history, and conquer
                the Spiral Abyss.
              </p>
            </div>
          </Link>
          ...
          <Link
            to="/nikke/roster"
            className="glass-panel group relative block cursor-pointer overflow-hidden border-pink-500/30 p-8 transition-all duration-500 hover:-translate-y-1 hover:border-pink-400 hover:shadow-[0_0_40px_-10px_rgba(236,72,153,0.3)]"
          >
            ...
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-pink-500/20 blur-3xl transition-all duration-700 group-hover:bg-pink-400/30" />

            <div className="relative z-10 flex h-full flex-col">
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-pink-500/20 p-2 text-pink-400 transition-all group-hover:scale-110 group-hover:bg-pink-500/30">
                    <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <span className="rounded-md border border-pink-500/30 bg-pink-500/20 px-2 py-1 text-xs font-bold text-pink-300">
                  NEW
                </span>
              </div>
              <p className="flex-grow text-pink-100/70">
                Command your Nikke squad. Track limits breaks, manage Overload gear, and prepare for
        ...
        <section className="mt-16">
          <h2 className="mb-6 text-2xl font-bold tracking-tight text-white">Quick Navigation</h2>
