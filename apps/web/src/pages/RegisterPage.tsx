...
function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-4">
      ...
      <div className="bg-accent-500/10 pointer-events-none absolute right-1/4 top-1/4 h-96 w-96 rounded-full mix-blend-screen blur-3xl"></div>
      <div className="pointer-events-none absolute bottom-1/4 left-1/4 h-96 w-96 rounded-full bg-indigo-500/10 mix-blend-screen blur-3xl"></div>
      ...
      <div className="animate-fade-in relative z-10 w-full max-w-sm">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm font-medium text-zinc-400">Create your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm text-white placeholder-zinc-600 transition-colors focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
              />
            </div>
